...
def run_validation():
    ...
    # Initialize session with dummy data (required for LayerEngine)
    ...
    # Mock some historical wins for this state
    for _ in range(20):
    ...
    print(f"Initial Table Size: {len(engine.prob_table.table)} states")
