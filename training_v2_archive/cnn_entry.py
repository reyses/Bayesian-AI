...
Usage:
    python training/cnn_entry.py                    # full run, all tiers
    python training/cnn_entry.py --tier BASE_NMP    # single tier
    python training/cnn_entry.py --max-k 8          # max clusters
"""
import os
import sys
import argparse
...
# Data paths
BLENDED_TRADES = 'training_v2/output/trades/blended_is.pkl'
REGRET_FILE = 'training_v2/output/nn/regret_analysis.csv'
FEATURES_DIR = 'DATA/FEATURES_79D_5s'
OUTPUT_DIR = 'training_v2/output/entry'
