...
Usage:
    ...
    mem.save('training_v2/output/memory/memory.pkl')
    mem = BayesianMemory.load('training_v2/output/memory/memory.pkl')
"""
import os
import pickle
import numpy as np
...
class BayesianMemory:
    ...
    def save(self, path: str = 'training_v2/output/memory/memory.pkl'):
        """Save to disk."""
    ...
    @staticmethod
    def load(path: str = 'training_v2/output/memory/memory.pkl') -> 'BayesianMemory':
        """Load from disk."""
