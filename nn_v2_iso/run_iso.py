...
Usage:
    python nn_v2_iso/run_iso.py                    # full pipeline
    python nn_v2_iso/run_iso.py --from 3           # from phase 3
    python nn_v2_iso/run_iso.py --phase1-only      # just collect trades
"""
import os
import sys
import glob
...
FEATURES_DIR_SEQ = 'DATA/FEATURES_79D_5s_v2'
ATLAS_1M = 'DATA/ATLAS/1m'
OUTPUT_DIR = 'nn_v2_iso/output'
...
def run_iso_forward(target='is'):
    ...
    from nn_v2_iso.nightmare_iso import IsoEngine
