...
from training_iso_v2.cnn.dataset import build_dataset, _resolve_days
from training_iso_v2.cnn.model import V2DirectionCNN, GRID_H, GRID_W


OUTPUT_DIR = 'training_iso_v2/output/cnn'
