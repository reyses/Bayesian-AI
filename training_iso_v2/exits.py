...
from training_iso_v2.state import BarState, REGIME_VOCAB
from training_iso_v2.ledger import Position
from training_iso_v2.v2_cols import (z_se_w, swing_noise_w, price_velocity_w,
                                          reversion_prob_w)
...
class BayesConditionalExit(ExitRule):
    ...
    def _load_table(self):
        ...
        from training_iso_v2.filters.bayes_conditional_exit import (
