...
Usage:
    ...
    python -m training_v2.regret_by_regime --regret training_iso_v2/output/regret_full_nmp.pkl
"""
...
from training_iso_v2.regret_full import FullRegretLabel, ACTIONS
