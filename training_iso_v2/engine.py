...
from training_iso_v2.ledger import Ledger, ClosedTrade
from training_iso_v2.strategies.base import Strategy
...
class Engine:
    ...
    def _open(self, state: BarState, sig, cnn_filtered: bool,
        ...
        if self.threshold_map is not None:
            from training_iso_v2.threshold_optimizer import lookup_thresholds
