# Dossier signal league — direction agreement with AI labels (COMPLETE, 25 streams)
(train 2024, test 2025+26, day-block bootstrap CIs; baseline 0.50; assembled 2026-07-16
from the three pipeline runs — per-stream evaluate() outputs verbatim)
...
1. **Graded separators** — OHLC-01, VP-01, VWMA-10, ADX-08, ROUND-05, SAR-23,
   SEASON-12, CROSS-11, RENKO-24, DOW-19, CURVE, VWAP-03, TUNNEL-20, ZONE-21:
   balanced-ish base + real tercile ladders. The stage-0 corpus.
2. **Inverters** — PIVOT-16 (0.05), ATR-09 (0.01), RSI-06 (0.04), MACD-07 (0.05),
   SCALP-18 (0.02), FIB-17/VA-13 (0.33): EVERY fade/divergence/pullback article
   premise is anti-aligned — they fire mid-move while the label rides the move.
   Flipped, they are continuation confirmations.
3. **Momentum tautologies** — ZIGZAG (0.96), ORB-02 (0.97): right by construction;
   the value is timing (see zigzag_phase_in_label.md).

> Per-stream coefs and train/test Ns: see the run logs (docs 081/083) and
> `signal_rows_<det>.parquet` (all 25 saved; regenerate via dossier_signal_pipeline.py).
