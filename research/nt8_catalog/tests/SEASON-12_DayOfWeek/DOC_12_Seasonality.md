...
|---|---|---|---|
| Tue | +0.143 | [-0.041, +0.327] | No |
| Wed | -0.051 | [-0.253, +0.150] | No |
| Thu | +0.095 | [-0.103, +0.278] | No |
| Fri | +0.022 | [-0.164, +0.204] | No |
...
| Day | Contrast (Day - Mon) | 95% CI | Significant? |
|---|---|---|---|
| Tue | +0.172 | [-0.037, +0.366] | No |
| Wed | +0.349 | [+0.146, +0.538] | Yes |
| Thu | +0.275 | [+0.072, +0.473] | Yes |
| Fri | +0.118 | [-0.095, +0.333] | No |
