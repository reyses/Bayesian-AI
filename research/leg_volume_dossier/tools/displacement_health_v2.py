#!/usr/bin/env python3
"""DISPLACEMENT HEALTH v2 — leg-phase-aligned pilot (owner 2026-07-25:
...
Writes reports/displacement_health_v2.md + assets/displacement_health_v2.png.
"""
import glob
import json
import os
...
OUT_MD = os.path.join(PROJ, 'reports', 'displacement_health_v2.md')
OUT_PNG = os.path.join(PROJ, 'reports', 'assets', 'displacement_health_v2.png')
...
def main():
    ...
    lines = ['# Displacement health v2 — leg-phase-aligned PILOT',
    ...
    ax.set_title(f'Displacement health v2 (leg-phase aligned) — {N_DAYS_PILOT}-day pilot')
