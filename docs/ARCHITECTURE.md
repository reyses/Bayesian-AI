...
|------|------:|------------|---------|
| `live/live_engine.py` | 2059 | `LiveEngine` | Main live trading loop — mirrors Phase 4 on real-time NT8 feed |
...
| `live/launcher.py` | 257 | `main()` | Entry point for live mode |
...
| File | Lines | Purpose |
|------|------:|---------|
| `visualization/dashboard.py` | 1772 | Tkinter "Fractal Command Center" (1600x950): training Pareto + live price/PnL |
