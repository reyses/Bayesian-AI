...
|------|------:|------------|---------|
| `live/live_engine.py` | 2386 | `LiveEngine` | Main live trading loop — mirrors Phase 4 on real-time NT8 feed |
...
| `live/bar_aggregator.py` | 362 | `LiveBarAggregator` | 1s→15s OHLCV aggregation with state recomputation |
