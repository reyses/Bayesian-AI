...
> Last updated: 2026-03-27. CUDA-only (CPU fallback removed).
...
|------|------:|------------|---------|
| `live/live_engine.py` | 2791 | `LiveEngine` | Main live trading loop — mirrors Phase 4 on real-time NT8 feed |
...
| `live/bar_aggregator.py` | 363 | `LiveBarAggregator` | 1s→15s OHLCV aggregation with state recomputation |
...
| `live/launcher.py` | 290 | `main()` | Entry point for live mode |
...
## Total: ~35,813 lines across core/, live/, training/, visualization/
