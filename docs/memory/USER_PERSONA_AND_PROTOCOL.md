...
> Deduplicated 2026-06-12: the file previously held 3 copies of every section
> (one mojibake-damaged consolidation + a self-embedding + raw source appends).
> One clean copy of each of the 7 topics kept; pre-dedupe original archived at
> archive/USER_PERSONA_AND_PROTOCOL_pre-condense_2026-06-12.md. Content unchanged.
...
**Scope (user clarification, 2026-06-12): "the metaphors are for communication,
not for the code."** Use his metaphor vocabulary in chat, explanations, and design
discussion. Code stays statistical-only — identifiers, labels, chart titles, and
new-code comments follow the CLAUDE.md metaphor purge. Two layers, both rules stand.
