// =============================================================================
// ZigzagRunner 1.0.5.1-RC -- 2026-04-27  (BUGFIX: minute-aligned bar series)
// =============================================================================
//
...
{
    public class ZigzagRunner_v1051 : Strategy
    {
        // ── Settings ─────────────────────────────────────────────────────
        ...
        public PivotAction_v1051 OnHighPivot { get; set; }
        ...
        public PivotAction_v1051 OnLowPivot { get; set; }
        ...
        // ── Version ──────────────────────────────────────────────────────
        private const string VERSION = "1.0.5.1-RC";
        ...
        // Internal accounting of estimated commission. NT8's own Trade
        // Performance display is NOT affected by these — it uses the
        // broker-template PnL. We just track and print at session end.
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                OnHighPivot                      = PivotAction_v1051.Short;  // v1.0 baseline (counter-trend)
                OnLowPivot                       = PivotAction_v1051.Long;   // v1.0 baseline (counter-trend)
            ...
            else if (State == State.Terminated)
            {
                ...
                Print(string.Format(
                    "[v1.0.5.1-RC COST SUMMARY] roundtrips={0}  est_commission=${1:F2}  " +
        ...
        protected override void OnBarUpdate()
        {
            ...
            if (action == PivotAction_v1051.Skip)
                return;

            if (action == PivotAction_v1051.Short)
                EnterShort(Contracts, "ShortAt" + pivotLabel);
            else  // PivotAction_v1051.Long
    ...
    // ═════════════════════════════════════════════════════════════════════
    // PivotAction_v1051 (v1.0.5.1-RC, 2026-04-27)
    // ─────────────────────────────────────────────────────────────────────
