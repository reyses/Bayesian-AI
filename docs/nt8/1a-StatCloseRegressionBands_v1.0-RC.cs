...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private _1a_StatCloseRegressionBands_v10[] cache_1a_StatCloseRegressionBands_v10;
		...
		{
			if (cache_1a_StatCloseRegressionBands_v10 != null)
				for (int idx = 0; idx < cache_1a_StatCloseRegressionBands_v10.Length; idx++)
					if (cache_1a_StatCloseRegressionBands_v10[idx] != null && cache_1a_StatCloseRegressionBands_v10[idx].CloseTimeFrameType == closeTimeFrameType && cache_1a_StatCloseRegressionBands_v10[idx].CloseTimeFrameValue == closeTimeFrameValue && cache_1a_StatCloseRegressionBands_v10[idx].Period == period && cache_1a_StatCloseRegressionBands_v10[idx].ShowSigma1 == showSigma1 && cache_1a_StatCloseRegressionBands_v10[idx].ShowSigma2 == showSigma2 && cache_1a_StatCloseRegressionBands_v10[idx].ShowSigma3 == showSigma3 && cache_1a_StatCloseRegressionBands_v10[idx].ShowSigma4 == showSigma4 && cache_1a_StatCloseRegressionBands_v10[idx].EqualsInput(input))
						return cache_1a_StatCloseRegressionBands_v10[idx];
			return CacheIndicator<_1a_StatCloseRegressionBands_v10>(new _1a_StatCloseRegressionBands_v10(){ CloseTimeFrameType = closeTimeFrameType, CloseTimeFrameValue = closeTimeFrameValue, Period = period, ShowSigma1 = showSigma1, ShowSigma2 = showSigma2, ShowSigma3 = showSigma3, ShowSigma4 = showSigma4 }, input, ref cache_1a_StatCloseRegressionBands_v10);
		}
	}
}
