...
| Date | Summary |
|------|---------|
| 2026-04-11 | NEW BASELINE: $1,077/day IS, $1,187/day OOS, $1,414/day NT8 (physics only, no CNN). Rarity waterfall, direction flips, lookback filters, MTF_BREAKOUT tier, conviction exits. 2x previous baseline. |
