...
| Date | Summary |
|------|---------|
| 2026-04-04 | nn_v2 full pipeline. NMP→regret→tree→AI. Continuous positioning: $711/day OOS (84% winning). Honest sequential build running overnight. Per-day IS iteration to 74%. |
