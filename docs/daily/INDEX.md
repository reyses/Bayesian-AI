...
| Date | Summary |
|------|---------|
| 2026-04-10 | Physics baseline: $599/day OOS. Training/live parity refactor: 5s cadence, timestamp bars_held, tier exits for manual trades. 18 files, build_dataset_v2→build_dataset rename. |
