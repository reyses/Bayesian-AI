...
| Date | Summary |
|------|---------|
| 2026-04-10 | Physics baseline: $599/day OOS (deterministic, no CNN). CNN non-deterministic ($365-$740). Numba JIT merged. Baseline protocol. Non-NMP entries isolated. |
