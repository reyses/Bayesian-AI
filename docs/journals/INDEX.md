...
| Date | Summary |
|------|---------|
| 2026-03-21 | IS BarProcessor refactor: deleted 1,029-line inline loop, replaced with ~350-line process_bar() wrapper. Hooks for 1s sub-bar, slippage, equity gate. Live maintenance flatten added. Peak detection lookahead bug fixed. |
