...
| Date | Summary |
|------|---------|
| 2026-03-22 | PhysicsEngine LIVE (sim). BarProcessor→AdvanceEngine rename. Deleted replay dead code (-1302 lines). 6 live bugs fixed during first sim. First principles C&E matrix: Price/Time/Volume base measurements, 13-feature set (4 grounded derivs, 3 distribution, 3 structural, 3 cross). Coherence decoded (inverted std, not entropy). Variance ratio replaces Hurst+ADX. DMI restored as cross-signal. Fibonacci research line opened. |
