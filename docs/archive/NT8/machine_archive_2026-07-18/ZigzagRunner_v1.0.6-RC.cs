// =============================================================================
// ZigzagRunner 1.0.6-RC -- 2026-04-27  (Trade management: SL + MFE-cut + Trail)
// =============================================================================
//
...
{
    public class ZigzagRunner_v106 : Strategy
    {
        // ── Settings ─────────────────────────────────────────────────────
        ...
        public PivotAction_v106 OnHighPivot { get; set; }
        ...
        public PivotAction_v106 OnLowPivot { get; set; }
        ...
        // ── Version ──────────────────────────────────────────────────────
        private const string VERSION = "1.0.6-RC";
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                OnHighPivot                      = PivotAction_v106.Short;  // counter-trend
                OnLowPivot                       = PivotAction_v106.Long;   // counter-trend
            ...
            else if (State == State.Terminated)
            {
                ...
                Print(string.Format(
                    "[v1.0.6-RC COST SUMMARY] roundtrips={0}  est_commission=${1:F2}  " +
        ...
        protected override void OnBarUpdate()
        {
            ...
            if (action == PivotAction_v106.Skip)
                return;

            if (action == PivotAction_v106.Short)
                EnterShort(Contracts, "ShortAt" + pivotLabel);
            else  // PivotAction_v106.Long
    ...
    // ═════════════════════════════════════════════════════════════════════
    // PivotAction_v106 (v1.0.5.1-RC, 2026-04-27)
    // ─────────────────────────────────────────────────────────────────────
