...
# Output to notebooks/master_dashboard.ipynb
os.makedirs('notebooks', exist_ok=True)
with open('notebooks/master_dashboard.ipynb', 'w') as f:
    json.dump(notebook, f, indent=1)

print("Notebook generated successfully: notebooks/master_dashboard.ipynb")
