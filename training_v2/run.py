...
from training_v2.ticker import V2Ticker, MultiDayV2Ticker
from training_v2.engine import Engine
from training_v2.strategies import (MAAlignTrendFollow, ReversionFromExtreme,
                                              VelocityBodyChord, RegimeAwareReversion,
                                              FilteredRegimeAwareReversion)
from training_v2.exits import default_exit_suite
from training_v2.regime_router import RegimeRouter
from training_v2.v2_cols import swing_noise_w


OUTPUT_DIR = 'training_v2/output'
...
def _build_cnn_hooks(args):
    ...
    if not args.cnn:
        return None, None
    from training_v2.cnn.inference import CNNFilter, CNNEntry
