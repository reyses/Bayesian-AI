...
This is the SAME pattern from training/build_dataset.py line 284, which was
the fix for the lookahead bug identified in the prior audit. The semantics:
...
Usage:
    python training/build_dataset_v2.py --atlas DATA/ATLAS --fresh
    python training/build_dataset_v2.py --atlas DATA/ATLAS --days 5
    python training/build_dataset_v2.py --atlas DATA/ATLAS --start 2025-06-01 --end 2025-06-30
"""
