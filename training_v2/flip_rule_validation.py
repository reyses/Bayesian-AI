...
def main():
    ...
    p.add_argument('--oos-regret-out', default='training_v2/output/regret_nmp_oos.pkl')
    p.add_argument('--thresholds', default='training_v2/output/thresholds_prod.json')
    ...
    if not os.path.exists(args.oos_regret_out):
        from training_v2.regret import label_trades
