...
(loaded from training_v2/output/cell_filters.json), check the cell's top
...
from training_v2.strategies.base import EntrySignal
from training_v2.strategies.regime_aware import RegimeAwareReversion, DEFAULT_FLIP_CELLS


DEFAULT_FILTERS_PATH = 'training_v2/output/cell_filters.json'
