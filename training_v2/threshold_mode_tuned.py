...
Usage:
    python -m training_v2.threshold_mode_tuned --regret training_v2/output/regret_nmp.pkl \
        --out training_v2/output/thresholds_mode.json
"""
...
from training_v2.threshold_optimizer import DEFAULT_THRESHOLDS
...
def main():
    ...
    p.add_argument('--out', default='training_v2/output/thresholds_mode.json')
