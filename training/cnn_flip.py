...
Usage:
    python training/cnn_flip.py                    # train with defaults
    python training/cnn_flip.py --epochs 50        # more epochs
    python training/cnn_flip.py --no-path          # entry only, no path
"""
import os
import sys
import pickle
...
from core_v2.features import FEATURE_NAMES, TF_ORDER, N_CORE, N_HELPER, N_TFS
