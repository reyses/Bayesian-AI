"""CLI runner — V2-native pipeline.
    ...
    python -m training.pipelines.v2_native --is                       # IS only
    python -m training.pipelines.v2_native --oos                      # OOS only
    python -m training.pipelines.v2_native --is --oos                 # both
    python -m training.pipelines.v2_native --days 2025_06_15,2025_06_16
    python -m training.pipelines.v2_native --start 2025-06-01 --end 2025-06-30
"""
...
from training.utils.ticker import V2Ticker, MultiDayV2Ticker
from core_v2.strategy_engine import Engine
from training.strategies import (MAAlignTrendFollow, ReversionFromExtreme,
                                              VelocityBodyChord, RegimeAwareReversion,
                                              FilteredRegimeAwareReversion)
from core_v2.exits import default_exit_suite
from training.utils.regime_router import RegimeRouter
from training.utils.v2_cols import swing_noise_w
...
def _build_cnn_hooks(args):
    ...
    if not args.cnn:
        return None, None
    from training.models.cnn.inference import CNNFilter, CNNEntry
