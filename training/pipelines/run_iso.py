...
Usage:
    python -m training.pipelines.v2_native_iso --is
    python -m training.pipelines.v2_native_iso --oos
    python -m training.pipelines.v2_native_iso --is --thresholds path/to/thresholds.json
    python -m training.pipelines.v2_native_iso --tiers FADE_CALM,KILL_SHOT,CASCADE
"""
...
from training.regret.regret_full import (label_trades_full, FullRegretLabel,
                                                          ACTIONS)
...
from training.strategies._nmp_base import NMPBaseStrategy
