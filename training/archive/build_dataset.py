...
Usage:
  python training/build_dataset.py                         # all days, 1m
  python training/build_dataset.py --resolution 5s         # all days, 5s
  python training/build_dataset.py --days 5                # first 5 days
  python training/build_dataset.py --start 2026-01-01      # from date
"""
import warnings
...
from core_v2.features_79d import (
