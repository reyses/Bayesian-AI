...
from training.regret.regret_full import FullRegretLabel
from training.regret.regret import RegretLabel
from training.ledger import ClosedTrade
from training.calibration.tier_discovery import load_joined, cohens_d
...
def main():
    ...
    p.add_argument('--regret-simple', default='training_iso_v2/output/regret_nmp.pkl')
    p.add_argument('--regret-full', default='training_iso_v2/output/regret_full_nmp.pkl')
    p.add_argument('--out', default='training_iso_v2/output/zband_anchors.json')
