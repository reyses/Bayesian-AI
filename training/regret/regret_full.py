...
Usage:
    python -m training.regret.regret_full --trades training_iso_v2/output/nmp_only.pkl \
        --out training_iso_v2/output/regret_full.pkl
...
from training.ledger import ClosedTrade, TICK, TICK_VALUE
from training.regret.regret import _load_5s_ohlcv, _compute_pnl_path
...
def _parse_args():
    ...
    p.add_argument('--out', default='training_iso_v2/output/regret_full.pkl')
