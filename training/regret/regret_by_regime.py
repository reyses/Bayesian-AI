...
Usage:
    python -m training.regret.regret_by_regime
    python -m training.regret.regret_by_regime --regret training_iso_v2/output/regret_full_nmp.pkl
"""
...
from training.regret.regret_full import FullRegretLabel, ACTIONS
...
def main():
    ...
    p.add_argument('--regret', default='training_iso_v2/output/regret_full_nmp.pkl')
