...
Usage:
    ...
    mem.save('training/output/memory/memory.pkl')
    mem = BayesianMemory.load('training/output/memory/memory.pkl')
"""
import os
import pickle
import numpy as np
...
class BayesianMemory:
    ...
    def save(self, path: str = 'training/output/memory/memory.pkl'):
        """Save to disk."""
    ...
    @staticmethod
    def load(path: str = 'training/output/memory/memory.pkl') -> 'BayesianMemory':
        """Load from disk."""
